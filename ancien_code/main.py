...
def start():
    ...
    fond_chargement = fonction.load_image("chargement.png")

    persoDroite1 = fonction.load_image("perso1d.png")
    persoDroite2 = fonction.load_image("perso2d.png")
    persoGauche1 = fonction.load_image("perso1g.png")
    persoGauche2 = fonction.load_image("perso2g.png")

    ok = fonction.load_image("ok.png")
    

    ballonBasket = fonction.load_image("ballon_de_basket.png")
    podium = fonction.load_image("podium.png")
    podium_egalite = fonction.load_image("podium_egalite.png")
    fond = fonction.load_image("terrain_basket.png")

    barrePouvoirJ1 = fonction.load_image("barrePouvoirsJ1.png")
    barrePouvoirJ2 = fonction.load_image("barrePouvoirsJ2.png")
    barrePouvoirJ1_vide = fonction.load_image("barrePouvoirsJ1_vide.png")
    barrePouvoirJ2_vide = fonction.load_image("barrePouvoirsJ2_vide.png")    
    barreScore = fonction.load_image("barreScore.png")

    image_tp_ball = fonction.load_image("Tp_ball.png")
    image_inverse_commande = fonction.load_image("inverse_commande.png")
    image_freeze_ball = fonction.load_image("freeze_ball.png")
    image_freeze_joueur = fonction.load_image("freeze_joueur.jpg")
